        ...
        <div>
            <div>
                ...
                <div className="Style__Root-sc-8or44v-3 bKAMRJ">
                    <div className={`Style__Step-sc-8or44v-2 bwDVRZ ${
                    ["/preloaders/seats", "/new/checkout", "/new/done/ticket"].some(path => location.pathname.startsWith(path)) 
                    ? "bwDVRZ-active" 
                    : ""
                    }`}>
                    ...
                    <div className={`Style__Step-sc-8or44v-2 cUrbmx ${
                    ["/new/checkout", "/new/done/ticket"].some(path => location.pathname.startsWith(path)) 
                    ? "cUrbmx-active" 
                    : ""
                    }`}>
                    ...
                    <div  className={`Style__Step-sc-8or44v-2 cUrbmx ${
                    ["/new/done/ticket"].some(path => location.pathname.startsWith(path)) 
                    ? "cUrbmx-active" 
                    : ""
                    }`}>
