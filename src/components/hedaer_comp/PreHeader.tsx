...
export default function PreHeader({ logoSrc,backgroundColor,textColor }: PreHeaderProps) {
        ...
        <div className="menu">
          ...
          setIsSupportOpen(!isSupportOpen);
            ...
            <div className="support-img">
              <svg width="16" height="16" viewBox="0 0 16 16" fill={textColor}>
          ...
          <div className="language-switch">
            <div className="language-switch-box">
              <span style={{
                color: textColor || 'defaultTextColor', borderBlockColor: textColor || 'defaultTextColor' 
                }}>Укр</span>
