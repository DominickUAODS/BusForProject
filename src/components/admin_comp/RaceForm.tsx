		...
		<div>
			...
			<form onSubmit={handleSubmit}>
				<div>
					...
					<input type="datetime-local" name="time_start" value={race?.time_start} onChange={handleChange} required />
				</div>
				<div>
					<label>End time</label>
					<input type="datetime-local" name="time_end" value={race?.time_end} onChange={handleChange} required />
				</div>
				<div>
					<label>Cost</label>
					<input type="number" name="cost" value={race?.cost} min="0.01" step="0.01" onChange={handleChange} required />
				</div>
				<div>
					<label>Places</label>
					<input type="number" name="places" value={race?.places} min="10" max="50" onChange={handleChange} required />
				</div>
				...
				<button type="submit" disabled={loading}>{id ? "Update Race" : "Create Race"}</button>
			</form>
			{id && (
				<button
